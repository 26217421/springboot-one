...
import com.jlu.wbw.one.dao.RoleDao;
import com.jlu.wbw.one.dao.RolePermissionDao;
...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public Results<SysRole> getRoleByFuzzyRoleNamePage(String roleName, Integer offset, Integer limit) {
        return Results.success(roleDao.countRoleByFuzzyRoleName(roleName).intValue(), roleDao.getRoleByFuzzyRoleNamePage(roleName,offset, limit));
    }
}
